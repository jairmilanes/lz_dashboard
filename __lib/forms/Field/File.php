...
class File extends Field
{
    ...
    public function returnField($form_name, $name, $value = '', $group = '')
    {
        ...
        return array(
            ...
            'field' => ( sprintf('<input type="file" name="%2$s[%3$s][%1$s]" id="%2$s_%3$s_%1$s"/>', $name, $form_name, $group).'<button class="upload_button" data-parent="'.$form_name.'_'.$name.'">Upload</button>' ),
            'html' => $this->html
        );
    }
